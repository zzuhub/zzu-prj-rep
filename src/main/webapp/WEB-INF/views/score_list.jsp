...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/score_del.js">
</script>
</head>
<body>
				   ...
				   <table class="table table-hover table-bordered">
				        ...
				        <tbody>
                          <c:forEach items="${scores}" var="score">
	                         <tr class="active">
					            <td name="sid">${score.scoreId}</td>
					            <td>${score.student.studentId}</td>
					            <td>
					              <a href="${pageContext.request.contextPath}/Student/findDetailsById/${score.student.studentId}">
					                 &nbsp;${score.student.studentName}
					              </a>
					            </td>
					            <td>${score.course.term}</td>
					            <td>
					              <a href="${pageContext.request.contextPath}/Course/findDetailsById/${score.course.courseId}">
					                ${score.course.courseName}
					              </a>
					            </td>
					            <td>${score.score}</td>
					            <td>
					               <a href="${pageContext.request.contextPath}/Score/doEdit/${score.scoreId}">
					                  <span class="glyphicon glyphicon-edit">编辑</span>    
					               </a>
					            </td>
					            <td>
					               <a href="${pageContext.request.contextPath}/Score/doRemove/${score.scoreId}" name="delHref">
                             ...
                             <tr class="active">
                                 <td colspan="8">
                                   <!-------------------------------分页插件↓----------------------------------------------------------------->
                                   <form action="${pageContext.request.contextPath}/Score/list" method="POST" name="spForm" id="spForm">

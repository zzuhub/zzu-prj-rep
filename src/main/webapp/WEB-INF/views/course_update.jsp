			...
			<div class="m-right">
				<div class="main container">
				   ...
				   <form class="form-horizontal" role="form" 
				         action="${pageContext.request.contextPath}/Course/doUpdate"
				         method="POST">
				      <div class="form-group" id="courseNameDiv">
						    <label for="courseName" class="col-sm-2 control-label">课程名称</label>
						    <div class="col-sm-5">
						      <input type="hidden" value="${course.courseId}" id="courseId" name="courseId">
				      ...
				      <div class="form-group" id="noteDiv">
						    ...
						    <div class="col-sm-5">
						      <textarea class="form-control" rows="3" id="note" name="note" >${course.note}</textarea>
						    </div>
                           ...
                           <div class="col-xs-3">
	                           <select class="form-control input-sm col-sm-5" id="term" name="term">
	                               ...
	                               <c:forEach items="${termMap}" var="term">
	                                    <c:choose>
	                                       <c:when test="${course.term==term.key}">
                           ...
                           <div class="col-xs-3">
                              <select class="form-control input-sm col-sm-5" id="credit" name="credit">
	                               ...
	                               <c:forEach items="${credits}" var="credit">
	                                    <c:choose>
	                                       <c:when test="${course.credit==credit}">

...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/course_del.js">
</script>
</head>
<body>
				        ...
				        <tbody>
                          <c:forEach items="${courses}" var="course">
	                         <tr class="active">
					            ...
					            <td name="cn">${course.courseName}</td>
					            <td>${course.note}</td>
					            <td>${course.term==0?"&nbsp;":course.term}</td>
					            ...
					            <td>
					               <a href="${pageContext.request.contextPath}/Course/doEdit/${course.courseId}">
					                  <span class="glyphicon glyphicon-edit">编辑</span>    
					               </a>
					            </td>
					            <td>
					               <a href="${pageContext.request.contextPath}/Course/doRemove/${course.courseId}" name="delHref">

			...
			<div class="m-right">
				<div class="main container">
				   ...
				   <form class="form-horizontal" role="form" 
				         action="${pageContext.request.contextPath}/Teach/doUpdate"
				         method="POST">
				      <div class="form-group" id="teacherIdDiv">
						    <label for="teacherId" class="col-sm-2 control-label">教师编号</label>
						    <div class="col-sm-5">
						      <input type="hidden" name="teachId" id="teachId" value="${teach.teachId}">
						      <input type=text class="form-control" 
						             name="teacherId" id="teacherId"
						             placeholder="请输入教师编号" value=${teach.teacherId}>
						    </div>
                           ...
                           <div class="col-xs-3">
	                           <select class="form-control input-sm col-sm-5" id="term" name="term">
	                               ...
	                               <c:forEach items="${termMap}" var="term">
	                                    <c:choose>
	                                       <c:when test="${term.key==teach.course.term}">
	                                            <!-- 默认回显-->
	                                            <option value="${term.key}" selected="selected">${term.value}</option>
	                                       </c:when>
	                                       <c:otherwise>
                       ...
                       <div class="form-group" id="courseIdDiv">
                           ...
                           <div class="col-xs-3">
	                           <select class="form-control input-sm col-sm-5" id="courseId" name="courseId">
	                               ...
	                               <option value="${teach.course.courseId}" selected="selected">${teach.course.courseName}</option>
	                           </select>
                           </div>
                       ...
                       <div class="form-group" id="clazzIdDiv">
                           ...
                           <div class="col-xs-3">
	                           <select class="form-control input-sm col-sm-5" id="clazzId" name="clazzId">
	                               ...
	                               <option value="${teach.clazz.clazzId}" selected="selected">${teach.clazz.clazzName}</option>
	                           </select>
                           </div>
                           <div><span class="col-sm-5" id="courseIdSpan"></span></div>
                       </div>

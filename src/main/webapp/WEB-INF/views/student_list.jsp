...
<!-- 自定义分页的JS插件 -->
<script type="text/javascript" src="${pageContext.request.contextPath}/js/pagination.js">
</script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/student_del.js">
</script>
</head>
<body>
				   ...
				   <table class="table table-hover table-bordered">
				        ...
				        <tbody>
                          <c:forEach items="${students}" var="student">
	                         <tr class="active">
					            <td>
					              <a href="${pageContext.request.contextPath}/Student/findDetailsById/${student.studentId}">
					                ${student.studentId}
					              </a>
					            </td>
					            <td name="sm">
					            ...
					            <td>${student.sex}</td>
					            <td>
					             <a href="${pageContext.request.contextPath}/Clazz/findDetailsById/${student.clazz.clazzId}">
					            ...
					            <td>
					               <a href="${pageContext.request.contextPath}/Student/doEdit/${student.studentId}">
					                  <span class="glyphicon glyphicon-edit">编辑</span>    
					               </a>
					            </td>
					            <td>
					               <a href="${pageContext.request.contextPath}/Student/doRemove/${student.studentId}" name="delHref">
                             ...
                             <tr class="active">
                                 <td colspan="13">
                                   <!-------------------------------分页插件↓----------------------------------------------------------------->
                                   <form action="${pageContext.request.contextPath}/Student/list" method="POST" name="spForm" id="spForm">

...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/clazz_del.js">
</script>
</head>
<body>
				        ...
				        <tbody>
                          <c:forEach items="${clazzs}" var="clazz">
	                         <tr class="active">
					            ...
					            <td>
					               <a href="${pageContext.request.contextPath}/Clazz/doEdit/${clazz.clazzId}">
					                  <span class="glyphicon glyphicon-edit">编辑</span>    
					               </a>
					            </td>
					            <td>
					               <a href="${pageContext.request.contextPath}/Clazz/doRemove/${clazz.clazzId}" name="delHref">
                             ...
                             <tr class="active">
                                 <td colspan="8">
                                   <!-------------------------------分页插件↓----------------------------------------------------------------->
                                   <form action="${pageContext.request.contextPath}/Clazz/list" method="POST" name="spForm" id="spForm">

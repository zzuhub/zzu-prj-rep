			...
			<div class="m-right">
				<div class="main container">
				   ...
				   <form class="form-horizontal" role="form" 
				         action="${pageContext.request.contextPath}/Major/doUpdate"
				         method="POST">
				      <input type="hidden" value="${major.majorName}" id="oldMajorName" name="oldMajorName">
				      <div class="form-group" id="majorNameDiv">
						    <label for="majorName" class="col-sm-2 control-label">专业名称</label>
						    <div class="col-sm-5">
						      <input type="hidden" name="majorId" id="majorId" value="${major.majorId}"/>
						      <input type="hidden" name="createTime" id="createTime" value="${major.createTime}"/>
						      <input type=text class="form-control" 
						             name="majorName" id="majorName" 
						             placeholder="请输入专业名称" value="${major.majorName}">
						    </div>
				       ...
				       <div class="form-group" id="noteDiv">
						    ...
						    <div class="col-sm-5">
						      <textarea class="form-control" rows="3" id="note" name="note">${major.note}</textarea>
						    </div>

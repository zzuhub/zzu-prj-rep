...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/major_del.js">
</script>
</head>
<body>
				   ...
				   <table class="table table-hover table-bordered">
				        ...
				        <tbody>
                          <c:forEach items="${majors}" var="major">
	                         <tr class="active">
					            <td>${major.majorId}</td>
					            <td name="mn">${major.majorName}</td>
					            <td>${major.note}</td>
					            <td>
					               <fmt:formatDate value="${major.createTime}" pattern="yyyy-MM-dd hh:mm"/>
					            </td>
					            <td>
					            ...
					            <td>
					               <a href="${pageContext.request.contextPath}/Major/doEdit/${major.majorId}">
					                  <span class="glyphicon glyphicon-edit">编辑</span>    
					               </a>
					            </td>
					            <td>
					               <a href="${pageContext.request.contextPath}/Major/doRemove/${major.majorId}" name="delHref">
                             ...
                             <tr class="active">
                                 <td colspan="8">
                                   <!-------------------------------分页插件↓----------------------------------------------------------------->
                                   <form action="${pageContext.request.contextPath}/Major/list" method="POST" name="spForm" id="spForm">

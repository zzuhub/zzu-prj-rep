			...
			<div class="m-right">
				<div class="main container">
				   ...
				   <form class="form-horizontal" role="form" 
				         action="${pageContext.request.contextPath}/Clazz/doUpdate"
				         method="POST">
				      <div class="form-group" id="clazzNameDiv">
						    <label for="clazzName" class="col-sm-2 control-label">班级名称</label>
						    <div class="col-sm-5">
						      <input type="hidden" value="${clazz.clazzId}" id="clazzId" name="clazzId">
						      <input type="hidden" value="${clazz.clazzName}" id="oldClazzName" name="oldClazzName">
						      <input type=text class="form-control" 
						             name="clazzName" id="clazzName"
						             placeholder="请输入专业名称" value="${clazz.clazzName}">
						    </div>
                           ...
                           <div class="col-xs-3">
	                           <select class="form-control input-sm col-sm-5" id="major" name="major.majorId">
	                               ...
	                               <c:forEach items="${majors}" var="major">
	                                    <c:choose>
	                                       <c:when test="${major.majorId==clazz.major.majorId}">
